...
export const authApi = {
   ...
   * 邀请码登录
   */
  async loginWithInviteCode(inviteCode: string): Promise<ResponseModel<LoginResponse>> {
   ...
   * 登出
   */
  async logout(): Promise<ResponseModel<any>> {
    return makeRequest<any>('/users/logout', {
      method: 'POST',
    });
  },
   ...
   * 验证邀请码
   */
  async verifyInviteCode(code: string): Promise<ResponseModel<{ valid: boolean }>> {
    return makeRequest<{ valid: boolean }>('/users/verify-invite-code', {
      method: 'POST',
  ...
  /**
   * 用户注册（支持邀请码注册 + 直接注册，invite_code 可选）
   */
  async register(data: {
    email: string;
    password: string;
    ...
    if (data.invite_code != null && data.invite_code !== '') {
      body.invite_code = data.invite_code;
    }
    return makeRequest<any>('/users/register', {
      method: 'POST',
      body: JSON.stringify(body),
    });
  },

  async sendOtp(email: string): Promise<ResponseModel<SendOtpResponse>> {
    return makeRequest<SendOtpResponse>('/users/send-otp', {
      method: 'POST',
      body: JSON.stringify({ email }),
    });
  },

  async verifyOtp(email: string, otpCode: string): Promise<ResponseModel<VerifyOtpResponse>> {
    return makeRequest<VerifyOtpResponse>('/users/verify-otp', {
      method: 'POST',
      body: JSON.stringify({
        email,
        otp_code: otpCode,
...
export const userApi = {
   ...
   * 获取当前用户信息
   */
  async getCurrentUser(): Promise<ResponseModel<any>> {
    return makeRequest<any>('/users/me', {
      method: 'GET',
    });
  },
   ...
   * 获取用户积分信息
   */
  async getUserCredits(): Promise<ResponseModel<any>> {
    return makeRequest<any>('/users/credits', {
      method: 'GET',
    });
  },
...
export const creationsApi = {
  ...
  async publish(data: PublishCreationRequest): Promise<ResponseModel<any>> {
    return makeRequest<any>('/creations/publish', {
      method: 'POST',
      body: JSON.stringify(data),
    });
  },

  async getMyPublished(): Promise<ResponseModel<{ items: any[]; total?: number }>> {
    return makeRequest<{ items: any[]; total?: number }>('/users/me/creations', {
      method: 'GET',
    });
  },

  async deletePublished(uuid: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/users/me/creations/${encodeURIComponent(uuid)}`, {
      method: 'DELETE',
    });
  },
};
...
export const videoAnalysisApi = {
   ...
   */
  async getAnalysisData(uuid: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/video-analysis/analysis/${uuid}`, {
      method: 'GET',
   ...
   */
  async getAnalysisDataByThreadId(threadId: string): Promise<ResponseModel<any>> {
    return makeRequest<any>('/video-analysis/analysis-by-thread', {
      method: 'POST',
   ...
   * 获取故事大纲详情
   */
  async getStoryOutlineData(uuid: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/video-analysis/story-outline/${uuid}`, {
      method: 'GET',
    }, CUTI_VIDEO_API_BASE_URL);
  },
   ...
   * 获取角色详情
   */
  async getCharactersData(uuids: string[]): Promise<ResponseModel<any>> {
    const uuidsParam = uuids.join(',');
    return makeRequest<any>(`/video-analysis/characters?uuids=${uuidsParam}`, {
      method: 'GET',
    }, CUTI_VIDEO_API_BASE_URL);
  },
   ...
   * 获取详细分镜详情
   */
  async getStoryboardDetailData(uuid: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/video-analysis/storyboard-detail/${uuid}`, {
      method: 'GET',
    }, CUTI_VIDEO_API_BASE_URL);
  },
   ...
   * 获取视频合成详情
   */
  async getVideoAssemblyData(uuid: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/video-analysis/video-assembly/${uuid}`, {
      method: 'GET',
    }, CUTI_VIDEO_API_BASE_URL);
  },

  async getVideoAssemblyDataByThreadId(threadId: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/video-analysis/video-assembly/thread/${threadId}`, {
      method: 'GET',
    }, CUTI_VIDEO_API_BASE_URL);
  },
   ...
   * 获取旁白数据
   */
  async getNarrationsData(conversationId: string, threadId: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/video-analysis/narrations?conversation_id=${conversationId}&thread_id=${threadId}`, {
      method: 'GET',
    }, CUTI_VIDEO_API_BASE_URL);
  },
   ...
   * 获取音效数据
   */
  async getAudioEffectsData(conversationId: string, threadId: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/video-analysis/audio-effects?conversation_id=${conversationId}&thread_id=${threadId}`, {
      method: 'GET',
    }, CUTI_VIDEO_API_BASE_URL);
  },
   ...
   * 根据UUIDs批量获取旁白数据
   */
  async getNarrationsByUuids(uuids: string[]): Promise<ResponseModel<any>> {
    const uuidsParam = uuids.join(',');
    return makeRequest<any>(`/video-analysis/narrations/by-uuids?uuids=${uuidsParam}`, {
      method: 'GET',
    }, CUTI_VIDEO_API_BASE_URL);
  },
   ...
   * 根据UUIDs批量获取音效数据
   */
  async getAudioEffectsByUuids(uuids: string[]): Promise<ResponseModel<any>> {
    const uuidsParam = uuids.join(',');
    return makeRequest<any>(`/video-analysis/audio-effects/by-uuids?uuids=${uuidsParam}`, {
      method: 'GET',
    }, CUTI_VIDEO_API_BASE_URL);
  },

  /** 方案 A：按 thread_id 聚合，一个 video space 展示该 thread 下所有 run 的数据 */
  async getScenesDataByThreadId(threadId: string): Promise<ResponseModel<any>> {
    return makeRequest<any>('/video-analysis/scenes-by-thread', {
      method: 'POST',
      body: JSON.stringify({ thread_id: threadId }),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async getChaptersByOutlineId(outlineUuid: string): Promise<ResponseModel<{ chapters: any[] }>> {
    return makeRequest<{ chapters: any[] }>(`/video-analysis/chapters-by-outline/${encodeURIComponent(outlineUuid)}`, {
      method: 'GET',
    }, CUTI_VIDEO_API_BASE_URL);
  },

  /** 编辑章节（直接改主表，无版本表）。uuid 与字段均在 request body。 */
  async patchChapter(body: { uuid: string; title?: string; description?: string; duration?: number; order?: number }): Promise<ResponseModel<any>> {
    return makeRequest<any>('/video-analysis/chapter', {
      method: 'POST',
      body: JSON.stringify(body),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async patchScene(body: { uuid: string; title?: string; description?: string; duration?: number }): Promise<ResponseModel<any>> {
    return makeRequest<any>('/video-analysis/scene', {
      method: 'POST',
      body: JSON.stringify(body),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  async getKeyframesDataByThreadId(threadId: string): Promise<ResponseModel<any>> {
    return makeRequest<any>('/video-analysis/keyframes-by-thread', {
      method: 'POST',
      body: JSON.stringify({ thread_id: threadId }),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  async getVideoGenerationsDataByThreadId(threadId: string): Promise<ResponseModel<any>> {
    return makeRequest<any>('/video-analysis/video-generations-by-thread', {
      method: 'POST',
      body: JSON.stringify({ thread_id: threadId }),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  async getMusicGenerationsDataByThreadId(threadId: string): Promise<ResponseModel<any>> {
    return makeRequest<any>('/video-analysis/music-generations-by-thread', {
      method: 'POST',
      body: JSON.stringify({ thread_id: threadId }),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  async getCharactersDataByThreadId(threadId: string, includeVersions = false): Promise<ResponseModel<any>> {
    const q = includeVersions ? '?include_versions=true' : '';
    return makeRequest<any>(`/video-analysis/characters-by-thread${q}`, {
      method: 'POST',
      body: JSON.stringify({ thread_id: threadId }),
    }, CUTI_VIDEO_API_BASE_URL);
  },
...
export const agentApi = {
  ...
  async submitTask(data: {
    ...
    if (dedupeKey && _submitTaskPending.has(dedupeKey)) {
      ...
      return _submitTaskPending.get(dedupeKey)!;
    }
  ...
  abortMessageStream(runId?: string) {
    ...
    if (streamAbortControllers[runId]) {
      streamAbortControllers[runId].abort();
      delete streamAbortControllers[runId];
    }
  },
  ...
  async submitClarification(threadId: string, data: {
    ...
    return makeRequest<any>('/agent-router/submit-clarification', {
      method: 'POST',
      body: JSON.stringify({
        thread_id: threadId,
   ...
   * 更新音乐提示词
   */
  async updateMusicPrompt(musicUuid: string, versionUuid: string, musicPrompt: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/agent-router/music-editing/update-prompt/${musicUuid}/${versionUuid}`, {
      method: 'PUT',
  ...
  async generateKeyframePrompt(request: {
    ...
    return makeRequest<any>('/agent-router/keyframe/generate-prompt', {
      method: 'POST',
...
export const conversationApi = {
   ...
   */
  async getConversationTaskDetail(runId: string): Promise<ResponseModel<any>> {
    return makeRequest<any>('/conversation/task-detail', {
      method: 'POST',
      body: JSON.stringify({ run_id: runId }),
    }, CUTI_VIDEO_API_BASE_URL);
  },
...
export const videoSegmentsApi = {
   ...
   * 根据UUID获取视频片段详情
   */
  async getVideoSegment(uuid: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/video-segments/${uuid}`, {}, CUTI_VIDEO_API_BASE_URL);
  },

  /**
   * 根据UUID获取Lipsync生成数据
   */
  async getLipsyncGeneration(lipsyncUuid: string, conversationId?: string): Promise<ResponseModel<any>> {
    const params = conversationId ? `?conversation_id=${conversationId}` : '';
    return makeRequest<any>(`/video-segments/lipsync/${lipsyncUuid}${params}`, {}, CUTI_VIDEO_API_BASE_URL);
  },
};
...
export const adminApi = {
   ...
   * 管理员登录
   */
  async adminLogin(username: string, password: string): Promise<ResponseModel<any>> {
    return makeRequest<any>('/admin/login', {
      method: 'POST',
   ...
   * 管理员登出
   */
  async adminLogout(): Promise<ResponseModel<any>> {
    return makeRequest<any>('/admin/logout', {
      method: 'POST',
    });
  },
   ...
   * 获取当前管理员信息
   */
  async getCurrentAdmin(): Promise<ResponseModel<any>> {
    return makeRequest<any>('/admin/me', {
      method: 'GET',
    });
  },
  ...
  async getUserInputsAndRuns(params: {
    ...
    return makeRequest<any>(`/admin/user-inputs-and-runs?${q}`, { method: 'GET' });
  },

  /**
   * 获取所有用户列表（支持分页、搜索、按状态筛选）
   */
  async getAllUsers(page: number = 1, size: number = 10, search?: string, status?: string): Promise<ResponseModel<any>> {
    ...
    return makeRequest<any>(`/admin/users?${params}`, {
      method: 'GET',
    });
  },
   ...
   */
  async getAllInviteCodes(page: number = 1, size: number = 10, search?: string, status?: string, source?: string): Promise<ResponseModel<any>> {
    const params = new URLSearchParams({
      page: page.toString(),
      size: size.toString(),
    });
    ...
    return makeRequest<any>(`/admin/invite-codes?${params}`, {
      method: 'GET',
    });
  },
   ...
   * 批量禁用邀请码
   */
  async disableInviteCodes(ids: number[]): Promise<ResponseModel<any>> {
    return makeRequest<any>('/admin/invite-codes/disable', {
      method: 'POST',
   ...
   */
  async getUserCredits(userId: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/admin/users/${userId}/credits`, {
      method: 'GET',
    });
  },
   ...
   * 获取用户积分历史
   */
  async getUserCreditHistory(userId: string): Promise<ResponseModel<any[]>> {
    return makeRequest<any[]>(`/admin/users/${userId}/credit-history`, {
      method: 'GET',
    });
  },
   ...
   * 添加用户积分
   */
  async addUserCredits(userId: string, amount: number, description?: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/admin/users/${userId}/add-credits`, {
      method: 'POST',
      body: JSON.stringify({
        amount,
  ...
  async generateBatchInviteCodes(request: {
    ...
    return makeRequest<any[]>('/admin/batch-invite-codes', {
      method: 'POST',
      body: JSON.stringify(request),
    });
  },
   ...
   * 批量标记邀请码已发送/取消已发送
   */
  async markInviteCodesSent(ids: number[], sent: boolean): Promise<ResponseModel<any>> {
    return makeRequest<any>('/admin/invite-codes/mark-sent', {
      method: 'POST',
  ...
  async getCreations(
    ...
    status?: string,
    search?: string
  ): Promise<ResponseModel<{ items: any[]; total: number; page: number; size: number }>> {
    const params = new URLSearchParams({ page: String(page), size: String(size) });
    if (status) params.set('status', status);
    if (search) params.set('search', search);
    return makeRequest<{ items: any[]; total: number; page: number; size: number }>(
  ...
  async updateCreation(
    ...
    return makeRequest<any>(`/admin/creations/${encodeURIComponent(uuid)}`, {
      method: 'PUT',
   ...
   * 删除 Explore 作品（软删除）
   */
  async deleteCreation(uuid: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/admin/creations/${encodeURIComponent(uuid)}`, {
      method: 'DELETE',
    });
  },
  ...
  async getCuratedStylePrompts(params: {
    ...
    return makeRequest<any[]>(`/admin/curated-style-prompts?${q}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  async getCuratedStylePromptByUuid(uuid: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/admin/curated-style-prompts/${uuid}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  async createCuratedStylePrompt(body: {
    ...
    return makeRequest<any>('/admin/curated-style-prompts', {
      method: 'POST',
      body: JSON.stringify(body),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  async updateCuratedStylePrompt(uuid: string, body: {
    ...
    return makeRequest<any>(`/admin/curated-style-prompts/${uuid}`, {
      method: 'PATCH',
      body: JSON.stringify(body),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async getMonitoringSystemLoad(): Promise<ResponseModel<{
    ...
    return makeRequest<any>('/admin/monitoring/system-load', { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async getMonitoringStats(): Promise<ResponseModel<{
    ...
    return makeRequest<any>('/admin/monitoring', { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async getShieldEvents(params?: {
    ...
    return makeRequest<any>(`/admin/shield-events?${q}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async getSmartTestingBaselineRun(runId: string): Promise<ResponseModel<{
    ...
    return makeRequest<any>(`/admin/smart-testing/baseline-runs/${encodeURIComponent(runId)}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async listSmartTestingBaselineBatches(scenario: string): Promise<ResponseModel<Array<{ batch_id: string; name: string; prompts_count: number; created_at?: string; has_image_urls?: boolean }>>> {
    return makeRequest<any>(`/admin/smart-testing/baseline-prompts/batches?scenario=${encodeURIComponent(scenario)}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 列出基准运行（最新在前） */
  async listSmartTestingBaselineRuns(limit?: number): Promise<ResponseModel<Array<{ run_id: string; status: string; created_at?: string; report_url?: string; results_count?: number; prompts_count?: number; tool_types?: string[] }>>> {
    ...
    return makeRequest<any>(`/admin/smart-testing/baseline-runs${q}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async getSmartTestingBaselineBatch(scenario: string, batchId: string): Promise<ResponseModel<{ batch_id: string; name: string; prompts: string[]; items?: Array<{ prompt: string; image_url?: string }>; created_at?: string }>> {
    return makeRequest<any>(`/admin/smart-testing/baseline-prompts/batches/${encodeURIComponent(scenario)}/${encodeURIComponent(batchId)}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async createSmartTestingBaselineBatch(params: { scenario: string; name: string; prompts?: string[]; items?: Array<{ prompt: string; image_url?: string }> }): Promise<ResponseModel<{ batch_id: string; name: string; prompts_count: number; created_at?: string }>> {
    return makeRequest<any>('/admin/smart-testing/baseline-prompts/batches', {
      method: 'POST',
      body: JSON.stringify(params),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async updateSmartTestingBaselineBatch(scenario: string, batchId: string, params: { name?: string; items?: Array<{ prompt: string; image_url?: string }> }): Promise<ResponseModel<{ batch_id: string; name: string; prompts_count: number; created_at?: string }>> {
    return makeRequest<any>(`/admin/smart-testing/baseline-prompts/batches/${encodeURIComponent(scenario)}/${encodeURIComponent(batchId)}`, {
      method: 'PUT',
      body: JSON.stringify(params),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async generateSmartTestingBaselinePrompts(params: { user_input: string; count: number; scenario?: string; save_batch_name?: string }): Promise<ResponseModel<{ batch_id: string; name: string; prompts_count: number; prompts: string[]; created_at?: string }>> {
    return makeRequest<any>('/admin/smart-testing/baseline-prompts/generate-with-agent', {
      method: 'POST',
      body: JSON.stringify(params),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async generateSmartTestingBaselinePromptsFromImages(params: { image_urls: string[]; user_input: string; count: number }): Promise<ResponseModel<{ items: Array<{ prompt: string; image_url?: string }> }>> {
    return makeRequest<any>('/admin/smart-testing/baseline-prompts/generate-from-images', {
      method: 'POST',
      body: JSON.stringify(params),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async getSmartTestingProductionPromptsCurrent(): Promise<ResponseModel<{ files: Record<string, string>; keyframe: Array<{ key: string; label: string }>; video: Array<{ key: string; label: string }> }>> {
    return makeRequest<any>('/admin/smart-testing/production-prompts/current', { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async modifySmartTestingProductionPrompt(params: { key: string; user_input: string; current_content?: string }): Promise<ResponseModel<{ key: string; draft_content: string }>> {
    return makeRequest<any>('/admin/smart-testing/production-prompts/modify-with-agent', {
      method: 'POST',
      body: JSON.stringify(params),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async saveSmartTestingProductionVariant(params: { variant_name: string; files: Record<string, string> }): Promise<ResponseModel<{ variant_id: string; name: string; created_at: string }>> {
    return makeRequest<any>('/admin/smart-testing/production-prompts/save-variant', {
      method: 'POST',
      body: JSON.stringify(params),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async listSmartTestingProductionVariants(): Promise<ResponseModel<Array<{ variant_id: string; name: string; created_at?: string; keys?: string[] }>>> {
    return makeRequest<any>('/admin/smart-testing/production-prompts/variants', { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 获取某变体内容 */
  async getSmartTestingProductionVariant(variantId: string): Promise<ResponseModel<{ variant_id: string; name: string; created_at?: string; files: Record<string, string> }>> {
    return makeRequest<any>(`/admin/smart-testing/production-prompts/variants/${encodeURIComponent(variantId)}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 列出 mock 数据集 */
  async listSmartTestingProductionDatasets(): Promise<ResponseModel<Array<{ dataset_id: string; name: string; created_at?: string; shots_count?: number }>>> {
    return makeRequest<any>('/admin/smart-testing/production-datasets', { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 创建 mock 数据集 */
  async createSmartTestingProductionDataset(params: { name: string; shots: Record<string, unknown>[]; character_images?: Record<string, unknown> }): Promise<ResponseModel<{ dataset_id: string; name: string; created_at: string }>> {
    return makeRequest<any>('/admin/smart-testing/production-datasets', {
      method: 'POST',
      body: JSON.stringify(params),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async getSmartTestingProductionDataset(datasetId: string): Promise<ResponseModel<{ dataset_id: string; name: string; created_at?: string; shots: unknown[]; character_images: Record<string, unknown> }>> {
    return makeRequest<any>(`/admin/smart-testing/production-datasets/${encodeURIComponent(datasetId)}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 获取 baseline 参考图数据集 */
  async getSmartTestingBaselineDatasetImages(): Promise<ResponseModel<{ urls: string[]; description?: string }>> {
    return makeRequest<any>('/admin/smart-testing/baseline-datasets/images', { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 写入 baseline 参考图数据集 */
  async putSmartTestingBaselineDatasetImages(params: { urls: string[]; description?: string }): Promise<ResponseModel<any>> {
    return makeRequest<any>('/admin/smart-testing/baseline-datasets/images', {
      method: 'PUT',
      body: JSON.stringify(params),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async getSmartTestingEligibleCombinations(): Promise<ResponseModel<Array<{ case_id: string; aspect_ratio: string; resolution: string; image_tool: string; video_tool: string; duration: number }>>> {
    return makeRequest<any>('/admin/smart-testing/eligible-combinations', { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async startSmartTestingFullRun(params: { function_case_ids?: string[]; effect_dataset_ids: string[]; effect_times: number; effect_tool_combo_ids?: string[] }): Promise<ResponseModel<{ full_run_id: string; message: string }>> {
    return makeRequest<any>('/admin/smart-testing/full-runs/start', { method: 'POST', body: JSON.stringify(params) }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 查询完整/效果测试运行进度 */
  async getSmartTestingFullRun(runId: string): Promise<ResponseModel<{ full_run_id: string; status: string; function_cases?: Array<{ case_id: string; run_id?: string; thread_id?: string; status: string }>; effect_cases?: Array<{ effect_case_id: string; run_id?: string; thread_id?: string; status: string }> }>> {
    return makeRequest<any>(`/admin/smart-testing/full-runs/${encodeURIComponent(runId)}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async reverifySmartTestingFullRunEffectCase(fullRunId: string, effectCaseId: string): Promise<ResponseModel<{ case: Record<string, unknown>; message: string }>> {
    return makeRequest<any>(`/admin/smart-testing/full-runs/${encodeURIComponent(fullRunId)}/effect-cases/${encodeURIComponent(effectCaseId)}/reverify`, { method: 'POST' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async listSmartTestingFullRuns(limit?: number): Promise<ResponseModel<Array<{ full_run_id: string; status: string; created_at?: string }>>> {
    const q = limit != null ? `?limit=${limit}` : '';
    return makeRequest<any>(`/admin/smart-testing/full-runs${q}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 全面测试 case 列表 */
  async getSmartTestingComprehensiveCases(): Promise<ResponseModel<Array<{ case_id: string; type: string; params: Record<string, unknown>; index: number }>>> {
    return makeRequest<any>('/admin/smart-testing/comprehensive-cases', { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 启动全面测试运行 */
  async startSmartTestingComprehensiveRun(params: { case_ids?: string[] }): Promise<ResponseModel<{ comprehensive_run_id: string; message: string }>> {
    return makeRequest<any>('/admin/smart-testing/comprehensive-runs/start', { method: 'POST', body: JSON.stringify(params) }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 查询全面测试运行进度 */
  async getSmartTestingComprehensiveRun(runId: string): Promise<ResponseModel<{ comprehensive_run_id: string; status: string; cases: Array<{ case_id: string; run_id?: string; status: string; error?: string }> }>> {
    return makeRequest<any>(`/admin/smart-testing/comprehensive-runs/${encodeURIComponent(runId)}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async reverifySmartTestingComprehensiveCase(comprehensiveRunId: string, caseId: string): Promise<ResponseModel<{ case: Record<string, unknown>; message: string }>> {
    return makeRequest<any>(`/admin/smart-testing/comprehensive-runs/${encodeURIComponent(comprehensiveRunId)}/cases/${encodeURIComponent(caseId)}/reverify`, { method: 'POST' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async runRegenerateTestForCase(comprehensiveRunId: string, caseId: string): Promise<ResponseModel<{ case: Record<string, unknown>; message: string }>> {
    return makeRequest<any>(`/admin/smart-testing/comprehensive-runs/${encodeURIComponent(comprehensiveRunId)}/cases/${encodeURIComponent(caseId)}/regenerate-test`, { method: 'POST' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async runRegenerateTestBatch(comprehensiveRunId: string, caseIds: string[]): Promise<ResponseModel<{ updated: number; results: Array<{ case_id: string; ok?: boolean; skipped?: boolean; reason?: string; error?: string }>; message: string }>> {
    return makeRequest<any>(`/admin/smart-testing/comprehensive-runs/${encodeURIComponent(comprehensiveRunId)}/regenerate-test-batch`, { method: 'POST', body: JSON.stringify({ case_ids: caseIds }) }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 列出全面测试运行 */
  async listSmartTestingComprehensiveRuns(limit?: number): Promise<ResponseModel<Array<{ comprehensive_run_id: string; status: string; created_at?: string }>>> {
    const q = limit != null ? `?limit=${limit}` : '';
    return makeRequest<any>(`/admin/smart-testing/comprehensive-runs${q}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async listConsistencyDatasets(datasetType: 'image' | 'video', limit?: number): Promise<ResponseModel<Array<{ dataset_id: string; name: string; dataset_type: string; created_at?: string; updated_at?: string; items?: unknown[] }>>> {
    const q = limit != null ? `?limit=${limit}` : '';
    return makeRequest<any>(`/admin/smart-testing/consistency-datasets/${datasetType}${q}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 一致性测试：创建测试集 */
  async createConsistencyDataset(params: { name: string; dataset_type: 'image' | 'video' }): Promise<ResponseModel<{ dataset_id: string; name: string; dataset_type: string; created_at: string }>> {
    return makeRequest<any>('/admin/smart-testing/consistency-datasets', { method: 'POST', body: JSON.stringify(params) }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 一致性测试：获取测试集详情 */
  async getConsistencyDataset(datasetType: 'image' | 'video', datasetId: string): Promise<ResponseModel<{ dataset_id: string; name: string; items: unknown[]; created_at?: string; updated_at?: string }>> {
    return makeRequest<any>(`/admin/smart-testing/consistency-datasets/${datasetType}/${encodeURIComponent(datasetId)}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 一致性测试：更新测试集名称 */
  async updateConsistencyDataset(datasetType: 'image' | 'video', datasetId: string, params: { name: string }): Promise<ResponseModel<unknown>> {
    return makeRequest<any>(`/admin/smart-testing/consistency-datasets/${datasetType}/${encodeURIComponent(datasetId)}`, { method: 'PATCH', body: JSON.stringify(params) }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 一致性测试：删除测试集 */
  async deleteConsistencyDataset(datasetType: 'image' | 'video', datasetId: string): Promise<ResponseModel<unknown>> {
    return makeRequest<any>(`/admin/smart-testing/consistency-datasets/${datasetType}/${encodeURIComponent(datasetId)}`, { method: 'DELETE' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async deleteConsistencyDatasetItem(datasetType: 'image' | 'video', datasetId: string, itemId: string): Promise<ResponseModel<unknown>> {
    return makeRequest<any>(`/admin/smart-testing/consistency-datasets/${datasetType}/${encodeURIComponent(datasetId)}/items/${encodeURIComponent(itemId)}`, { method: 'DELETE' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  > {
    return makeRequest<any>('/admin/smart-testing/consistency-options', { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async addConsistencyImageItem(datasetId: string, params: { keyframe_version_uuid: string; run_id?: string; thread_id?: string; shot_number: number; prompt_source?: string }): Promise<ResponseModel<{ dataset_id: string; item: unknown }>> {
    return makeRequest<any>(`/admin/smart-testing/consistency-datasets/image/${encodeURIComponent(datasetId)}/items`, { method: 'POST', body: JSON.stringify(params) }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async addConsistencyVideoItem(datasetId: string, params: { video_generation_version_uuid: string; run_id?: string; thread_id?: string; shot_number: number; prompt_source?: string }): Promise<ResponseModel<{ dataset_id: string; item: unknown }>> {
    return makeRequest<any>(`/admin/smart-testing/consistency-datasets/video/${encodeURIComponent(datasetId)}/items`, { method: 'POST', body: JSON.stringify(params) }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  > {
    return makeRequest<any>(`/admin/smart-testing/consistency-datasets/from-thread?thread_id=${encodeURIComponent(threadId)}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async batchAddConsistencyFromThread(params: {
    ...
    return makeRequest<any>('/admin/smart-testing/consistency-datasets/batch-add-from-thread', { method: 'POST', body: JSON.stringify(params) }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 一致性测试：启动运行 */
  async startConsistencyRun(params: { dataset_ids: Array<{ type: string; dataset_id: string }>; concurrency?: number }): Promise<ResponseModel<{ consistency_run_id: string; message: string }>> {
    return makeRequest<any>('/admin/smart-testing/consistency-runs/start', { method: 'POST', body: JSON.stringify(params) }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 一致性测试：列出运行 */
  async listConsistencyRuns(limit?: number): Promise<ResponseModel<Array<{ consistency_run_id: string; status: string; created_at?: string; cases?: unknown[] }>>> {
    const q = limit != null ? `?limit=${limit}` : '';
    return makeRequest<any>(`/admin/smart-testing/consistency-runs${q}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 一致性测试：获取运行详情 */
  async getConsistencyRun(runId: string): Promise<ResponseModel<{ run_id: string; status: string; created_at?: string; cases?: Array<{ item_id: string; type: string; passed?: boolean; reason?: string }> }>> {
    return makeRequest<any>(`/admin/smart-testing/consistency-runs/${encodeURIComponent(runId)}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async getRunContent(runId: string): Promise<ResponseModel<{ agent_type?: string; user_input?: string; user_input_files?: unknown; story_content?: string | null; music_content?: string | null; image_content?: string | null; story_title?: string; story_description?: string; story_themes?: string[]; music_urls?: string[]; image_urls?: string[]; video_url?: string }>> {
    return makeRequest<any>(`/admin/run-content/${encodeURIComponent(runId)}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async startSmartTestingFullAutoRun(params: { user_input: string; thread_id: string; user_option?: Record<string, unknown>; agent_type?: string; user_input_files?: Record<string, unknown> }): Promise<ResponseModel<{ run_id: string; thread_id: string; message: string }>> {
    return makeRequest<any>('/admin/smart-testing/full-auto-run', { method: 'POST', body: JSON.stringify(params) }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async listSmartTestingBenchmarkThreads(params?: { page?: number; page_size?: number }): Promise<ResponseModel<{ items: Array<{ run_id: string; thread_id: string; user_id: string; conversation_id?: number; status: string; user_input?: string; user_option?: Record<string, unknown>; user_input_files?: { images?: unknown[]; audio_files?: unknown[]; video_files?: unknown[] }; created_at?: string; completed_at?: string; agent_type?: string; run_type?: string }>; total: number; page: number; page_size: number }>> {
    ...
    return makeRequest<any>(`/admin/smart-testing/benchmark-dataset/threads${q}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async getSmartTestingBenchmarkRunDetail(runId: string): Promise<ResponseModel<{ run_id: string; run: Record<string, unknown>; task: Record<string, unknown>; character_versions_by_character: unknown[]; keyframe_versions: unknown[]; video_versions: unknown[] }>> {
    return makeRequest<any>(`/admin/smart-testing/benchmark-dataset/runs/${encodeURIComponent(runId)}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async createSmartTestingBenchmarkDataset(params: { name: string; thread_ids: string[] }): Promise<ResponseModel<{ dataset_id: string; name: string; thread_ids: string[]; created_at: string }>> {
    return makeRequest<any>('/admin/smart-testing/benchmark-dataset', { method: 'POST', body: JSON.stringify(params) }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 基准数据集：列表 */
  async listSmartTestingBenchmarkDatasets(limit?: number): Promise<ResponseModel<Array<{ dataset_id: string; name: string; thread_ids?: string[]; run_ids?: string[]; created_at?: string }>>> {
    const q = limit != null ? `?limit=${limit}` : '';
    return makeRequest<any>(`/admin/smart-testing/benchmark-dataset${q}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 效果测试数据集：详情 */
  async getSmartTestingBenchmarkDataset(datasetId: string): Promise<ResponseModel<{ dataset_id: string; name: string; thread_ids?: string[]; run_ids?: string[]; created_at?: string }>> {
    return makeRequest<any>(`/admin/smart-testing/benchmark-dataset/${encodeURIComponent(datasetId)}`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 效果测试数据集：更新名称 */
  async updateSmartTestingBenchmarkDataset(datasetId: string, params: { name: string }): Promise<ResponseModel<{ dataset_id: string; name: string; thread_ids?: string[]; created_at?: string }>> {
    return makeRequest<any>(`/admin/smart-testing/benchmark-dataset/${encodeURIComponent(datasetId)}`, { method: 'PATCH', body: JSON.stringify(params) }, CUTI_VIDEO_API_BASE_URL);
  },
  /** 智能测试 - 效果测试数据集：删除 */
  async deleteSmartTestingBenchmarkDataset(datasetId: string): Promise<ResponseModel<{ dataset_id: string; deleted: boolean }>> {
    return makeRequest<any>(`/admin/smart-testing/benchmark-dataset/${encodeURIComponent(datasetId)}`, { method: 'DELETE' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async getSmartTestingBenchmarkDatasetThreads(datasetId: string): Promise<ResponseModel<{ items: Array<{ run_id: string; thread_id: string; user_id: string; user_input?: string; user_option?: Record<string, unknown>; user_input_files?: { images?: { url?: string }[]; audio_files?: { url?: string }[]; video_files?: { url?: string }[] }; created_at?: string }>; dataset_id: string; name: string }>> {
    return makeRequest<any>(`/admin/smart-testing/benchmark-dataset/${encodeURIComponent(datasetId)}/threads`, { method: 'GET' }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async addSmartTestingBenchmarkDatasetItem(datasetId: string, body: { user_input: string; user_option?: Record<string, unknown>; user_input_files?: { images?: { url?: string }[]; audio_files?: { url?: string }[]; video_files?: { url?: string }[] } }): Promise<ResponseModel<{ dataset_id: string; item: { thread_id: string; run_id: string; user_id: string; user_input: string; user_option: Record<string, unknown>; user_input_files: Record<string, unknown>; created_at: string } }>> {
    return makeRequest<any>(`/admin/smart-testing/benchmark-dataset/${encodeURIComponent(datasetId)}/items`, { method: 'POST', body: JSON.stringify(body) }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async updateSmartTestingBenchmarkDatasetItem(datasetId: string, body: { thread_id: string; user_option: Record<string, unknown> }): Promise<ResponseModel<{ dataset_id: string; thread_id: string; user_option: Record<string, unknown> }>> {
    return makeRequest<any>(`/admin/smart-testing/benchmark-dataset/${encodeURIComponent(datasetId)}/items`, { method: 'PATCH', body: JSON.stringify(body) }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async adminVideoAssembly(request: {
    ...
    return makeRequest<any>('/admin/error-tracking/video-assembly', {
      method: 'POST',
      body: JSON.stringify(request),
    }, CUTI_VIDEO_API_BASE_URL);
  },
...
export const videoEditingApi = {
  ...
  async regenerateKeyframes(request: {
    ...
    return makeRequest<any>('/agent-router/video-editing/regenerate-keyframes', {
      method: 'POST',
      body: JSON.stringify(request),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async regenerateVideos(request: {
    ...
    return makeRequest<any>('/agent-router/video-editing/regenerate-videos', {
      method: 'POST',
      body: JSON.stringify(request),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async regenerateCharacters(request: {
    ...
    return makeRequest<any>('/agent-router/video-editing/regenerate-characters', {
      method: 'POST',
      body: JSON.stringify(request),
    }, CUTI_VIDEO_API_BASE_URL);
  },
  ...
  async regenerateCharacterMultiView(request: {
    ...
    return makeRequest<any>('/agent-router/video-editing/regenerate-character-multi-view', {
      method: 'POST',
      body: JSON.stringify(request),
    }, CUTI_VIDEO_API_BASE_URL);
  },
...
export const videoHistoryApi = {
  async getVideos(params?: {
  ...
  }): Promise<ResponseModel<{ total: number; videos: any[] }>> {
    const queryParams = new URLSearchParams();
    if (params?.limit) queryParams.append('limit', params.limit.toString());
    if (params?.offset) queryParams.append('offset', params.offset.toString());
    ...
    return makeRequest<{ total: number; videos: any[] }>(endpoint, {
      method: 'GET',
    }, API_BASE_URL);
  },

  async getVideoByUuid(videoUuid: string): Promise<ResponseModel<any>> {
    return makeRequest<any>(`/vault/videos/${videoUuid}`, {
      method: 'GET',
    }, API_BASE_URL);
  },
};
...
const creditPackagesApi = {
  getPackages: async (): Promise<ResponseModel<any[]>> => {
    return makeRequest<any[]>('/payment/packages');
  },
};
...
const paymentApi = {
  ...
  getPaymentDetails: async (sessionId: string): Promise<ResponseModel<any>> => {
    return makeRequest<any>(`/payment/payment-details/${sessionId}`);
  },

  getTransactions: async (limit: number = 20, offset: number = 0): Promise<ResponseModel<any[]>> => {
    return makeRequest<any[]>(`/payment/transactions?limit=${limit}&offset=${offset}`);
  },
};
...
export const inviteCodeApi = {
  ...
  markSent: (code: string): Promise<ResponseModel<any>> => {
