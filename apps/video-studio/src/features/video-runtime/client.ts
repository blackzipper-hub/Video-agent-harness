...
export interface RuntimeWorkspace {
  ...
  builds: Array<BuildSnapshot & { steps: RuntimeBuildStep[]; validations: RuntimeValidation[] }>;
...
export const videoRuntimeClient = {
  ...
  selectArtifact: (projectId: string, versionId: string, currentVersionId: string) => request<{
    projectId: string; artifactId: string; versionId: string; projectVersionId: string;
