...
// 事件类型到显示文本的映射
export const getEventDisplayMessage = (eventType: string, eventData?: any): string => {
 ...
 */
export const shouldHideMessage = (eventData?: any): boolean => {
  return eventData?.hidden === true;
};
