...
export const TRANSLATION_SCOPE_GLOB_EXCLUDES = [
  ...
  '**/.pytest_cache/**',
  'apps/web/dist/**',
  'apps/video-cli/runtime/**',
  'services/video-runtime/skills/external/**',
  '.artifacts/**',
...
function isTranslationSourceExcluded(file: string): boolean {
  ...
  return segments.some(segment => NON_SOURCE_DIRECTORIES.has(segment)
    ...
    || file.startsWith('apps/video-cli/runtime/')
    || file.startsWith('services/video-runtime/skills/external/')
