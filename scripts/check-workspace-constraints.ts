...
/** Source home for the independently published Cuti video extension packages. */
const cutiPublishedRepositoryUrl = 'git+https://github.com/testcoder-ui/video-agent-harness.git'
...
function checkWorkspace({ dir, manifest }: WorkspaceManifest): string[] {
  ...
  if (isPublicLandlockPackage) {
    ...
    // ([rationale](https://github.com/deepseek-ai/deepseek-harness/blob/b150a551b8d465e31e418e1b2eaf5e79bbb7d28e/.agents/notes/implemented/process/2026-08-13-public-vendor-and-native-sequences.md)).
    if (manifest.private === true) {
    ...
    const expectedRepositoryUrl = manifest.name?.startsWith('@cuti-ai/')
      ? cutiPublishedRepositoryUrl
