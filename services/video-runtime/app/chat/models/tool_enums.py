...
class ToolType(str, Enum):
    ...
    # HappyHorse 1.0 (Alibaba, via WaveSpeed) - image-to-video, 720p/1080p, 3-15s
    HAPPYHORSE_1_0_I2V = "happyhorse-1.0-i2v"
    # HappyHorse 1.1 (Alibaba, via WaveSpeed) - image-to-video, 720p/1080p, 3-15s
...
class DefaultValues:
    ...
    IMAGE_MODEL = ToolType.GEMINI_3_1_FLASH_IMAGE_PREVIEW  # 默认 Nano Banana 2："gemini-3.1-flash-image-preview"
