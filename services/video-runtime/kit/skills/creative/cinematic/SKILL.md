...
name: cinematic
description: >-
  Cinematic look craft: ban empty cinematic, ASL, audio layers, grade intent.
---
...
> For the universal cinematography vocabulary (camera, lens, motion, focus primitives, plus the 5-aspect Subject / Subject Motion / Scene / Spatial Framing / Camera spec), see `/kit/skills/creative/video-gen-prompting/SKILL.md`. This file layers cinematic-specific conventions on top of those primitives — it does not redefine them.
...
>
> The CMU/Harvard CHAI study showed subjective phrasing varies wildly across annotators and model interpretations, which means a beat tagged "moody" routes to a different visual every render. Replace the adjective with the lighting + grade + shot-duration combination that produces moodiness. See `/kit/skills/creative/storytelling/SKILL.md` "Anti-Subjective Rule" for the script-side equivalent.
>
