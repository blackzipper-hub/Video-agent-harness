...
name: short-form
description: >-
  Short-form retention: 1–3s hook, pacing, platform density.
---
...
3. **Captions are mandatory** — use `media.transcribe`, then `subtitle.compose`,
   then `media.subtitle_burn`; do not report completion before the captioned video exists
