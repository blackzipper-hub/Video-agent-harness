...
name: storytelling
description: >-
  Anti-subjective storytelling craft: but/therefore, camera intent, beat clarity.
---
...
>
> The rule applies to script narration AND to the metadata fields scene-director consumes. For the universal vocabulary that names these visual primitives, see `/kit/skills/creative/video-gen-prompting/SKILL.md`.
...
When writing a beat, attach one line of camera intent so the scene-director doesn't have to invent it from a blank slate. Use the universal vocabulary in `/kit/skills/creative/video-gen-prompting/SKILL.md` (Subject / Subject Motion / Scene / Spatial Framing / Camera). One line is enough — the scene-director will expand it.
