# short-drama-workflow: English Reading Copy

Reference translation for developers. **Documentation only; not a runtime Skill or installable bundle.**

Source: [original SKILL.md](../../../skills/external/short-drama-workflow/SKILL.md). Source SHA-256: `0d2879ed357858ef4bd247c878d8289e5affc44aa56ff1f977c948e51d223bed`.
...
description: >-
  ...
  wish-fulfillment short dramas, urban twist dramas, dialogue dramas, continuous multi-segment dramas, or an explicit user invocation of
...
- provider prompts may remain in Chinese when that helps legacy `seedance2`, but
  ...
  verbatim;
- words such as "English short drama", "English-language video", or "the entire video in English" count as an
