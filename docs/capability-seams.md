...
| --- | --- | --- | --- | --- | --- | --- |
| `ctx.videoRuntime` | `seam` | `video-runtime` | `video-runtime-http` | `tool-video` | - | The Python Runtime owns projects, artifacts, builds, and checkpoints; DeepSeek owns the agent loop. |
